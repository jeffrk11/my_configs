# Generated by Powerlevel10k configuration wizard on 2024-08-25 at 12:21 BST.
...
() {
  ...
  function prompt_example() {
    #memory
    local used_memory
    used_memory=$(free -h | awk '/^Mem:/ {print $3 "/" $2}')
    p10k segment +r -f 208 -i '🧮' -t "$used_memory"

    #docker containers
    local docker_count
    docker_count=$(docker ps -q | wc -l)
    p10k segment -f 10 -i '🐳' -t $docker_count

    #processos
    local process_count=$(ps aux | wc -l)
    p10k segment -f 153 -i '📟' -t $process_count 

    #ips
    # local ip_local=$(hostname -I | awk '{print $1}')
    # local ip_externo=$(curl -s ifconfig.me)
    # p10k segment -f 129 -i '🌐' -t "\n$ip_local  $ip_externo"
  }
